                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="all-form-element-inner">
                                            <form class="forms-sample" enctype="multipart/form-data" method="POST" action="{{ route('sosial.update',$sosial['id'])}}">
                                                @csrf
                                                        ...
                                                        <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                            <div class="form-select-list">
                                                                <select class="form-control  {{ $errors->first('user') ? "is-invalid":""}}" name="user" >
                                                                    ...
                                                                    <option value="{{ $item->id }}" {{$item->id == $sosial['users_id'] ? 'selected' : ''}}>{{ $item->name }}</option>
                                                                    @endforeach
                                                                </select>
                                                                @error('user')
                                                ...
                                                <div class="form-group-inner">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                            <input type="text" value="{{ $sosial['nama']}}"  class="form-control {{ $errors->first('nama') ? "is-invalid":""}}" class="form-control" name="nama" placeholder="nama organisasi" />
                                                ...
                                                <div class="form-group-inner">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                            <input type="date" value="{{ $sosial['tanggal']}}"  class="form-control {{ $errors->first('tanggal') ? "is-invalid":""}}" class="form-control" name="tanggal" placeholder="masukan tanggal"/>
                                                ...
                                                <div class="form-group-inner">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                            <input type="text" value="{{ $sosial['penyelenggara_sosial']}}"  class="form-control {{ $errors->first('penyelenggara_sosial') ? "is-invalid":""}}" class="form-control" name="penyelenggara_sosial" placeholder="masukan penyelenggara"/>
                                                ...
                                                <div class="form-group-inner">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                            @if ($sosial['foto'])  
                                                            <img src="{{ asset('img/'.$sosial['foto'])}}" width="120px" alt="gambar">                       
                                                            @else
                                                        ...
                                                        <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                            <div class="form-select-list">
                                                                <select class="form-control {{ $errors->first('semester_id') ? "is-invalid":""}}" name="semester_id">
                                                                    ...
                                                                    <option value="{{ $item->id }}" {{$item->id == $sosial['semester_id'] ? 'selected' : ''}}>{{ $item->nama }}</option>
                                                                    @endforeach
                                                                </select>
