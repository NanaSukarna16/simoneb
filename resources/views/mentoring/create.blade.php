                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="all-form-element-inner">
                                            <form class="forms-sample" enctype="multipart/form-data" method="POST" action="{{ route('mentoring.store')}}">
                                                @csrf
                                                ...
                                                <div class="form-group-inner">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                            <input type="text" value="{{ old('nama')}}"  class="form-control {{ $errors->first('nama') ? "is-invalid":""}}" class="form-control" name="nama" placeholder="nama mentor" />
                                                ...
                                                <div class="form-group-inner">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                            <input type="number" value="{{ old('jml_pertemuan')}}"  class="form-control {{ $errors->first('jml_pertemuan') ? "is-invalid":""}}" class="form-control" name="jml_pertemuan" placeholder="Jumlah Pertemuan"/>
                                                ...
                                                <div class="form-group-inner">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                            <input type="number" value="{{ old('jml_kehadiran')}}"  class="form-control {{ $errors->first('jml_kehadiran') ? "is-invalid":""}}" class="form-control" name="jml_kehadiran" placeholder="Jumlah Kehadiran"/>
                                                ...
                                                <div class="form-group-inner">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                            <input type="number" value="{{ old('persen')}}"  class="form-control {{ $errors->first('persen') ? "is-invalid":""}}" class="form-control" name="persen" placeholder="persen"/>
