            ...
            <div class="sparkline10-hd">
                <div style="margin-top: 8px" class="main-sparkline10-hd">
                    ...
                    <a  href="{{route('forum.create')}}">
                        <button style="margin-top: 10px" type="button" class="btn btn-success btn-rounded btn-icon" data-toggle="tooltip" data-placement="bottom" title="Tambah Forum">
                 ...
                 <div class="static-table-list" style="overflow-x: auto">
                    <table class="table table-striped table-bordered">
                        ...
                        <tbody>
                            @php
                                $no = 1;
                                $forum = DB::table('forum')->where('users_id', Auth::user()->id)->get();
                            @endphp
                            ...
                            <tr>
                                ...
                                <td style="width: 150px">
                                    <center>
                                        <a style="text-decoration: none" href="{{route('forum.edit',$item->id)}}">
