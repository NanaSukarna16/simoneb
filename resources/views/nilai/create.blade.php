                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="all-form-element-inner">
                                            <form class="forms-sample" enctype="multipart/form-data" method="POST" action="{{ route('nilai.store')}}">
                                                @csrf
                                                ...
                                                <div class="form-group-inner">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                            <input type="number" value="{{ old('ipk')}}" step="any" class="form-control {{ $errors->first('ipk') ? "is-invalid":""}}" class="form-control" name="ipk" placeholder="4.00"/>
                                                ...
                                                <div class="form-group-inner">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                            <input type="number" value="{{ old('ips')}}" step="any" class="form-control {{ $errors->first('ips') ? "is-invalid":""}}" class="form-control" name="ips" placeholder="4.00"/>
                                                ...
                                                <div class="form-group-inner">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                            <input type="text" value="{{ old('tahun')}}"  class="form-control {{ $errors->first('tahun') ? "is-invalid":""}}" class="form-control" name="tahun" placeholder="2021/2022"/>
                                                ...
                                                <div class="form-group-inner">
                                                    <div class="row">
                                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                            <label class="login2 pull-right pull-right-pro">Foto/Pdf</label>
                                                        </div>
                                                        <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
