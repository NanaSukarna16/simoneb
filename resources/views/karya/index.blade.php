                    ...
                    <table class="table table-striped table-bordered">
                        <thead>
                            <tr class="bg-success">
                                ...
                                <th style="text-align: center">Judul Karya</th>
                        ...
                        <tbody>
                            @php
                                $no = 1;
                                $karya = DB::table('karya')->where('users_id', Auth::user()->id)->get();
                            @endphp
                            ...
                            <tr>
                                ...
                                <td style="width: 150px">
                                    <center>
                                        <a style="text-decoration: none" href="{{route('karya.edit',$item->id)}}">
                                        ...
                                        <a href="{{route('karya.destroy',$item->id)}}">
