                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="all-form-element-inner">
                                            <form class="forms-sample" enctype="multipart/form-data" method="POST" action="{{ route('pesan.update',$pesan['id'])}}">
                                                @csrf
                                                <div class="form-group-inner">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                            <input type="text" value="{{ $pesan['messages']}}"  class="form-control {{ $errors->first('messages') ? "is-invalid":""}}" class="form-control" name="messages" placeholder="masukan pesan" />
                                                        ...
                                                        <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                            <div class="form-select-list">
                                                                <select class="form-control {{ $errors->first('semester_id') ? "is-invalid":""}}" name="semester_id">
                                                                    ...
                                                                    <option value="{{ $item->id }}" {{$item->id == $pesan['semester_id'] ? 'selected' : ''}}>{{ $item->nama }}</option>
                                                                    @endforeach
                                                                </select>
                                                        ...
                                                        <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                            <div class="form-select-list">
                                                                <select class="form-control  {{ $errors->first('user') ? "is-invalid":""}}" name="user" >
                                                                    ...
                                                                    <option value="{{ $item->id }}" {{$item->id == $pesan['users_id'] ? 'selected' : ''}}>{{ $item->name }}</option>
                                                                    @endforeach
                                                                </select>
                                                                @error('user')
                                                                <div class="alert alert-danger mt-2">
