                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="all-form-element-inner">
                                            <form class="forms-sample" enctype="multipart/form-data" method="POST" action="{{ route('laporan.store')}}">
                                                @csrf
                                                ...
                                                <div class="form-group-inner">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                            <input type="file" name="laporan" class="form-control {{ $errors->first('laporan') ? "is-invalid":""}}">
                                                            @error('laporan')
                                                            <div class="alert alert-danger mt-2">
                                                                {{ $message }}
                                                            </div>
