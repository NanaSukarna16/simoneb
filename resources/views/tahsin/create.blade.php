                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="all-form-element-inner">
                                            <form class="forms-sample" enctype="multipart/form-data" method="POST" action="{{ route('tahsin.store')}}">
                                                @csrf
                                                ...
                                                <div class="form-group-inner">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                            <input type="text" value="{{ old('no_sk')}}"  class="form-control {{ $errors->first('no_sk') ? "is-invalid":""}}" class="form-control" name="no_sk" placeholder="masukan no SK"/>
                                                ...
                                                <div class="form-group-inner">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                            <input type="number" value="{{ old('nilai')}}"  class="form-control {{ $errors->first('nilai') ? "is-invalid":""}}" class="form-control" name="nilai" placeholder="masukan nilai"/>
