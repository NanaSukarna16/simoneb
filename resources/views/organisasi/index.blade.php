            ...
            <div class="sparkline10-hd">
                <div style="margin-top: 8px" class="main-sparkline10-hd">
                    ...
                    <a  href="{{route('organisasi.create')}}">
                        <button style="margin-top: 10px" type="button" class="btn btn-success btn-rounded btn-icon" data-toggle="tooltip" data-placement="bottom" title="Tambah Organisasi">
                ...
                <div class="static-table-list" style="overflow-x: auto">
                    <table class="table table-striped table-bordered">
                        ...
                        <tbody>
                            @php
                                $no = 1;
                                $organisasi = DB::table('org_mhs')->where('users_id', Auth::user()->id)->get();
                            @endphp
                            @forelse ($organisasi as $item)   
                            <tr>
                                <td align="center" style="width: 50px">{{$no++}}</td>
                                <td align="center">{{$item->nama}}</td>
                                <td align="center" style="width: 150px">{{$item->jabatan}}</td>
                                <td align="center" style="width: 150px">{{$item->masa_jabatan}}</td>
                                <td align="center">
                                ...
                                <td style="width: 150px">
                                    <center>
                                        <a style="text-decoration: none" href="{{route('organisasi.edit',$item->id)}}">
                                        ...
                                        <a href="{{route('organisasi.destroy',$item->id)}}">
